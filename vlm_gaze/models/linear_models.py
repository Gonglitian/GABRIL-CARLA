...
class Encoder(nn.Module):
    def __init__(
        ...
        self._conv_5 = nn.Conv2d(
            in_channels=num_hiddens, out_channels=num_hiddens, kernel_size=(5,5), stride=1, padding=5//2
        )
        
        ## 20 x 38
        self._conv_6 = nn.Conv2d(
            in_channels=num_hiddens, out_channels=embedding_dim, kernel_size=(5,5), stride=1, padding=5//2
        )
...
if __name__=="__main__":
    ...
    print(z.shape, x_recon.shape, vq_loss.shape, quantized.shape, encoding_indices.shape)
