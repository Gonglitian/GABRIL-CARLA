...
def get_args():
    ...
    parser.add_argument('--confounded', action='store_true', help='Overlay action indicators onto frames during evaluation')
    parser.add_argument('--confounded_config', type=str, default='vlm_gaze/configs/confounded_render.yaml', help='YAML config for confounded overlay rendering')
